...
# Paradigm Wire Desktop Client

A secure and freedom-oriented chatting app.
...
Run this command to get a production-ready build and upload it to GitHub Releases. Be sure to save a release as a draft before doing this!
```
npm run release
```
